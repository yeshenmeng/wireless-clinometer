...
#define SYS_SW_SUB_VERSION					0X00 //软件子版本号
#define SYS_SW_MODIFY_VERSION				0X0000 //软件修改版本号
/* 硬件版本 */
#define SYS_HW_MAIN_VERSION					0X00 //硬件主版本号
#define SYS_HW_SUB_VERSION					0X00 //硬件子版本号
#define SYS_HW_MODIFY_VERSION				0X0000 //硬件修改版本号
#endif
