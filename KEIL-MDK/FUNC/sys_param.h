...
/* 设备配置参数 */
#define SYS_PARAM_DEV_GATEWAY_ADDR			{0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08} //网关地址
#define SYS_PARAM_DEV_LONG_ADDR				{0x08,0x07,0x06,0x05,0x04,0x03,0x02,0x01} //测点长地址
